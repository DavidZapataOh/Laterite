...
import { findAmmConfigPda } from '../pdas';
import { RAYDIUM_CP_SWAP_PROGRAM_ADDRESS } from '../programs';

export const CREATE_AMM_CONFIG_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
    137, 52, 237, 212, 215, 117, 108, 104,
]);

export function getCreateAmmConfigDiscriminatorBytes(): ReadonlyUint8Array {
    return fixEncoderSize(getBytesEncoder(), 8).encode(CREATE_AMM_CONFIG_DISCRIMINATOR);
}
...
> = {
    ...
    creatorFeeRate: CreateAmmConfigInstructionDataArgs['creatorFeeRate'];
};
...
> {
    ...
    const originalAccounts = {
        owner: { value: input.owner ?? null, isSigner: 'either', isWritable: true },
...
export function parseCreateAmmConfigInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    ...
    return {
        ...
        accounts: { owner: getNextAccount(), ammConfig: getNextAccount(), systemProgram: getNextAccount() },
