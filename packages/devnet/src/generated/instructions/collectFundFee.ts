...
export const COLLECT_FUND_FEE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([167, 138, 78, 149, 223, 194, 6, 126]);

export function getCollectFundFeeDiscriminatorBytes(): ReadonlyUint8Array {
    return fixEncoderSize(getBytesEncoder(), 8).encode(COLLECT_FUND_FEE_DISCRIMINATOR);
}
...
> {
    return combineCodec(getCollectFundFeeInstructionDataEncoder(), getCollectFundFeeInstructionDataDecoder());
}

export type CollectFundFeeAsyncInput<
    ...
    TAccountRecipientToken0Account extends InstructionAccountInput = InstructionAccountInput,
    TAccountRecipientToken1Account extends InstructionAccountInput = InstructionAccountInput,
...
> = {
    ...
    recipientToken0Account: TAccountRecipientToken0Account;
    /** The address that receives the collected token_1 fund fees */
    recipientToken1Account: TAccountRecipientToken1Account;
...
export async function getCollectFundFeeInstructionAsync<
    ...
    TAccountRecipientToken0Account extends InstructionAccountInput,
    TAccountRecipientToken1Account extends InstructionAccountInput,
...
>(
    ...
    CollectFundFeeInstruction<
        ...
        ResolvedInstructionAccountMeta<
            TAccountRecipientToken0Account,
            InstructionAccountInputAddress<TAccountRecipientToken0Account>
        >,
        ResolvedInstructionAccountMeta<
            TAccountRecipientToken1Account,
            InstructionAccountInputAddress<TAccountRecipientToken1Account>
        >,
...
> {
    ...
    const originalAccounts = {
        ...
        recipientToken0Account: { value: input.recipientToken0Account ?? null, isSigner: false, isWritable: true },
        recipientToken1Account: { value: input.recipientToken1Account ?? null, isSigner: false, isWritable: true },
...
export function parseCollectFundFeeInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
