...
export const COLLECT_PROTOCOL_FEE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
    136, 136, 252, 221, 194, 66, 126, 89,
]);

export function getCollectProtocolFeeDiscriminatorBytes(): ReadonlyUint8Array {
    return fixEncoderSize(getBytesEncoder(), 8).encode(COLLECT_PROTOCOL_FEE_DISCRIMINATOR);
}
...
export type CollectProtocolFeeAsyncInput<
...
export async function getCollectProtocolFeeInstructionAsync<
...
> {
    ...
    return Object.freeze({
        ...
        data: getCollectProtocolFeeInstructionDataEncoder().encode(args as CollectProtocolFeeInstructionDataArgs),
        programAddress,
...
>(
    ...
    return {
        ...
        data: getCollectProtocolFeeInstructionDataDecoder().decode(instruction.data),
    };
}
