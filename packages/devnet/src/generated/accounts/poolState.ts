...
export type PoolStateArgs = {
    ...
    enableCreatorFee: boolean;
    padding1: ReadonlyUint8Array;
    creatorFeesToken0: number | bigint;
    creatorFeesToken1: number | bigint;
    /** padding for future updates */
...
export function getPoolStateEncoder(): FixedSizeEncoder<PoolStateArgs> {
    return transformEncoder(
        getStructEncoder([
            ...
            ['enableCreatorFee', getBooleanEncoder()],
            ['padding1', fixEncoderSize(getBytesEncoder(), 6)],
            ['creatorFeesToken0', getU64Encoder()],
            ['creatorFeesToken1', getU64Encoder()],
            ['padding', getArrayEncoder(getU64Encoder(), { size: 28 })],
        ]),
...
export function getPoolStateDecoder(): FixedSizeDecoder<PoolState> {
    return getStructDecoder([
        ...
        ['enableCreatorFee', getBooleanDecoder()],
        ['padding1', fixDecoderSize(getBytesDecoder(), 6)],
        ['creatorFeesToken0', getU64Decoder()],
        ['creatorFeesToken1', getU64Decoder()],
        ['padding', getArrayDecoder(getU64Decoder(), { size: 28 })],
    ]);
}
