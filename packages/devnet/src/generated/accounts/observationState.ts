...
export const OBSERVATION_STATE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
    122, 174, 197, 53, 129, 9, 165, 132,
]);

export function getObservationStateDiscriminatorBytes(): ReadonlyUint8Array {
    return fixEncoderSize(getBytesEncoder(), 8).encode(OBSERVATION_STATE_DISCRIMINATOR);
}
