...
export const RAYDIUM_CP_SWAP_ERROR__TRANSFER_FEE_CALCULATE_NOT_MATCH = 0x177a; // 6010
/** MathOverflow: Math overflow */
export const RAYDIUM_CP_SWAP_ERROR__MATH_OVERFLOW = 0x177b; // 6011
/** InsufficientVault: Insufficient vault */
export const RAYDIUM_CP_SWAP_ERROR__INSUFFICIENT_VAULT = 0x177c; // 6012
/** InvalidFeeModel: Invalid fee model */
export const RAYDIUM_CP_SWAP_ERROR__INVALID_FEE_MODEL = 0x177d; // 6013
/** NoFeeCollect: Fee is zero */
export const RAYDIUM_CP_SWAP_ERROR__NO_FEE_COLLECT = 0x177e; // 6014
/** LamportsCalculateError: Lamports calculate error */
export const RAYDIUM_CP_SWAP_ERROR__LAMPORTS_CALCULATE_ERROR = 0x177f; // 6015
...
export type RaydiumCpSwapError =
    ...
    | typeof RAYDIUM_CP_SWAP_ERROR__INSUFFICIENT_VAULT
    | typeof RAYDIUM_CP_SWAP_ERROR__INVALID_FEE_MODEL
    ...
    | typeof RAYDIUM_CP_SWAP_ERROR__LAMPORTS_CALCULATE_ERROR
    | typeof RAYDIUM_CP_SWAP_ERROR__MATH_OVERFLOW
    | typeof RAYDIUM_CP_SWAP_ERROR__NO_FEE_COLLECT
    | typeof RAYDIUM_CP_SWAP_ERROR__NOT_APPROVED
    | typeof RAYDIUM_CP_SWAP_ERROR__NOT_SUPPORT_MINT
    | typeof RAYDIUM_CP_SWAP_ERROR__TRANSFER_FEE_CALCULATE_NOT_MATCH
...
if (process.env['NODE_ENV'] !== 'production') {
    raydiumCpSwapErrorMessages = {
        ...
        [RAYDIUM_CP_SWAP_ERROR__INSUFFICIENT_VAULT]: `Insufficient vault`,
        [RAYDIUM_CP_SWAP_ERROR__INVALID_FEE_MODEL]: `Invalid fee model`,
        ...
        [RAYDIUM_CP_SWAP_ERROR__LAMPORTS_CALCULATE_ERROR]: `Lamports calculate error`,
        [RAYDIUM_CP_SWAP_ERROR__MATH_OVERFLOW]: `Math overflow`,
        [RAYDIUM_CP_SWAP_ERROR__NO_FEE_COLLECT]: `Fee is zero`,
        ...
        [RAYDIUM_CP_SWAP_ERROR__TRANSFER_FEE_CALCULATE_NOT_MATCH]: `TransferFee calculate not match`,
...
export function getRaydiumCpSwapErrorMessage(code: RaydiumCpSwapError): string {
    if (process.env['NODE_ENV'] !== 'production') {
        return (raydiumCpSwapErrorMessages as Record<RaydiumCpSwapError, string>)[code];
    }

    return 'Error message not available in production bundles.';
}

export function isRaydiumCpSwapError<TProgramErrorCode extends RaydiumCpSwapError>(
    error: unknown,
    transactionMessage: { instructions: Record<number, { programAddress: Address }> },
    code?: TProgramErrorCode,
): error is SolanaError<typeof SOLANA_ERROR__INSTRUCTION_ERROR__CUSTOM> &
    Readonly<{ context: Readonly<{ code: TProgramErrorCode }> }> {
    return isProgramError<TProgramErrorCode>(error, transactionMessage, RAYDIUM_CP_SWAP_PROGRAM_ADDRESS, code);
}
