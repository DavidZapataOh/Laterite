    ...
    >
      <div className={styles.copy}>
        ...
        <p className={styles.figure}>
          ...
          <span className="sr-only">{dollars.format(BRICKS * PER_BRICK)} laid over one year at $25 a week</span>
...
function Bond({ courses, cols, laid, className }: { courses: Course[]; cols: number; laid: number; className: string }) {
  return (
