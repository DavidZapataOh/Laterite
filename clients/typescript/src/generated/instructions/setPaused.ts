...
export const SET_PAUSED_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([91, 60, 125, 192, 176, 225, 166, 218]);
...
export function parseSetPausedInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
