...
export const CHANGE_PAYMENT_TOKENS_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
    52, 157, 115, 114, 64, 43, 241, 2,
]);

export function getChangePaymentTokensDiscriminatorBytes(): ReadonlyUint8Array {
    return fixEncoderSize(getBytesEncoder(), 8).encode(CHANGE_PAYMENT_TOKENS_DISCRIMINATOR);
}

export type ChangePaymentTokensInstruction<
...
export type ChangePaymentTokensInstructionData = { discriminator: ReadonlyUint8Array; paymentTokens: number };

export type ChangePaymentTokensInstructionDataArgs = { paymentTokens: number };

export function getChangePaymentTokensInstructionDataEncoder(): FixedSizeEncoder<ChangePaymentTokensInstructionDataArgs> {
    return transformEncoder(
        getStructEncoder([
            ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
            ['paymentTokens', getU8Encoder()],
        ]),
        value => ({ ...value, discriminator: CHANGE_PAYMENT_TOKENS_DISCRIMINATOR }),
    );
}

export function getChangePaymentTokensInstructionDataDecoder(): FixedSizeDecoder<ChangePaymentTokensInstructionData> {
...
export function getChangePaymentTokensInstructionDataCodec(): FixedSizeCodec<
    ChangePaymentTokensInstructionDataArgs,
    ChangePaymentTokensInstructionData
> {
...
export function getChangePaymentTokensInstruction<
    TAccountUser extends InstructionSignerInput,
    TAccountVault extends InstructionAccountInput,
    TAccountSubscriptionsProgram extends InstructionAccountInput,
    TAccountSubscriptionsEventAuthority extends InstructionAccountInput,
...
export type ParsedChangePaymentTokensInstruction<
    TProgram extends string = typeof LATERITE_PROGRAM_ADDRESS,
...
export function parseChangePaymentTokensInstruction<
