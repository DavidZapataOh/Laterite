...
export const CHANGE_TIER_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([102, 152, 56, 92, 156, 1, 87, 130]);

export function getChangeTierDiscriminatorBytes(): ReadonlyUint8Array {
    return fixEncoderSize(getBytesEncoder(), 8).encode(CHANGE_TIER_DISCRIMINATOR);
}

export type ChangeTierInstruction<
...
export type ChangeTierInstructionData = { discriminator: ReadonlyUint8Array; tier: number };

export type ChangeTierInstructionDataArgs = { tier: number };

export function getChangeTierInstructionDataEncoder(): FixedSizeEncoder<ChangeTierInstructionDataArgs> {
    return transformEncoder(
        getStructEncoder([
            ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
            ['tier', getU8Encoder()],
        ]),
        value => ({ ...value, discriminator: CHANGE_TIER_DISCRIMINATOR }),
    );
}

export function getChangeTierInstructionDataDecoder(): FixedSizeDecoder<ChangeTierInstructionData> {
...
export function getChangeTierInstructionDataCodec(): FixedSizeCodec<
    ChangeTierInstructionDataArgs,
    ChangeTierInstructionData
> {
    return combineCodec(getChangeTierInstructionDataEncoder(), getChangeTierInstructionDataDecoder());
}

export type ChangeTierAsyncInput<
...
> = {
    ...
    tier: ChangeTierInstructionDataArgs['tier'];
};

export async function getChangeTierInstructionAsync<
...
> {
    ...
    return Object.freeze({
        ...
        data: getChangeTierInstructionDataEncoder().encode(args as ChangeTierInstructionDataArgs),
        programAddress,
    } as ChangeTierInstruction<
        TProgramAddress,
        ResolvedInstructionAccountMeta<TAccountUser, InstructionAccountInputAddress<TAccountUser>>,
        ResolvedInstructionAccountMeta<TAccountVault, InstructionAccountInputAddress<TAccountVault>>,
        ResolvedInstructionAccountMeta<
...
export function getChangeTierInstruction<
    TAccountUser extends InstructionSignerInput,
    TAccountVault extends InstructionAccountInput,
    TAccountSubscriptionsProgram extends InstructionAccountInput,
    TAccountSubscriptionsEventAuthority extends InstructionAccountInput,
...
export type ParsedChangeTierInstruction<
    TProgram extends string = typeof LATERITE_PROGRAM_ADDRESS,
...
> = {
    ...
    data: ChangeTierInstructionData;
};

export function parseChangeTierInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
    instruction: Instruction<TProgram> &
        InstructionWithAccounts<TAccountMetas> &
        InstructionWithData<ReadonlyUint8Array>,
): ParsedChangeTierInstruction<TProgram, TAccountMetas> {
    ...
    return {
        ...
        data: getChangeTierInstructionDataDecoder().decode(instruction.data),
    };
}
