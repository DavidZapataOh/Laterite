...
export type EnrollInstructionDataArgs = {
    tier: number;
    paymentTokens: number;
    asset: number;
    engine: EngineArgs;
...
> = {
    ...
    tier: EnrollInstructionDataArgs['tier'];
    paymentTokens: EnrollInstructionDataArgs['paymentTokens'];
    asset: EnrollInstructionDataArgs['asset'];
    engine: EnrollInstructionDataArgs['engine'];
    engineAmount: EnrollInstructionDataArgs['engineAmount'];
    incomeRule: EnrollInstructionDataArgs['incomeRule'];
    changeMultiplier: EnrollInstructionDataArgs['changeMultiplier'];
    cushions: EnrollInstructionDataArgs['cushions'];
    goalAmount: EnrollInstructionDataArgs['goalAmount'];
    goalLabel: EnrollInstructionDataArgs['goalLabel'];
};
