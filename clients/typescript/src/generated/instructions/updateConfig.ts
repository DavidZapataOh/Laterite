...
export type UpdateConfigInstructionData = { discriminator: ReadonlyUint8Array; settings: Settings };

export type UpdateConfigInstructionDataArgs = { settings: SettingsArgs };
...
> = {
    ...
    settings: UpdateConfigInstructionDataArgs['settings'];
};
