...
export function getProposeAdminDiscriminatorBytes(): ReadonlyUint8Array {
    return fixEncoderSize(getBytesEncoder(), 8).encode(PROPOSE_ADMIN_DISCRIMINATOR);
}
...
export type ProposeAdminInstructionData = { discriminator: ReadonlyUint8Array; newAdmin: Address };
...
export function parseProposeAdminInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
